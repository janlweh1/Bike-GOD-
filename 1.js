...
function confirmDelete() {
    ...
    // Find and remove bike
    const bikeIndex = allBikes.findIndex(b => b.id === currentDeleteBikeId);
    if (bikeIndex > -1) {
        allBikes.splice(bikeIndex, 1);
...
function handleAddBikeSubmit(e) {
    ...
    // Add to bikes array
    allBikes.unshift(newBike); // Add at the beginning
...
function handleEditBikeSubmit(e) {
    ...
    // Update bike data
    currentEditBike.name = document.getElementById('editBikeModel').value;
    currentEditBike.category = document.getElementById('editBikeType').value;
    currentEditBike.status = document.getElementById('editBikeStatus').value;
    currentEditBike.condition = document.getElementById('editBikeCondition').value;
    currentEditBike.price = parseInt(document.getElementById('editBikePrice').value);
    currentEditBike.speed = document.getElementById('editBikeSpeed').value;
    currentEditBike.weight = document.getElementById('editBikeWeight').value;
    currentEditBike.gears = document.getElementById('editBikeGears').value;
    currentEditBike.notes = document.getElementById('editBikeNotes').value;
